...
import com.practice.movies.data.MovieRepository;
import com.practice.movies.model.Genre;
...
public class MovieServiceTest {
    ...
    private List<Integer> getMovieIds(Collection<Movie> movies) {
        return (List<Integer>) movies.stream().map(Movie::getId).collect(Collectors.toList());
    }
}